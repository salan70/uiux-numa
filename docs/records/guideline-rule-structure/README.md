...
直前の 2 回の修正（[箱をやめる ADR](../../decisions/2026-09-21-catalog-guideline-plain-layout.md)、
[規則の構造 ADR](../../decisions/2026-09-21-catalog-guideline-rule-structure.md)）で
...
（[named variants ADR](../../decisions/2026-09-17-named-variants-and-unevaluated-decisions.md)）。
...
判断は [対比の対 ADR](../../decisions/2026-09-21-catalog-guideline-contrast-pair.md) に残す。
...
- 抽出した原則候補: [段の数は任意項目の有無で変えない](../../principles/block-shape-must-not-vary-by-optional-parts.md)、[良し悪しの色に画面の強調色を借りない](../../principles/semantic-color-must-not-borrow-the-accent.md)

- 公開実装: `apps/catalog/src/pages/GuidelinesPage.tsx`
- 直前の判断: [箱をやめる ADR](../../decisions/2026-09-21-catalog-guideline-plain-layout.md)、[規則の構造 ADR](../../decisions/2026-09-21-catalog-guideline-rule-structure.md)
- 規則の書式: [方針の書式 ADR](../../decisions/2026-09-20-guideline-format.md)
