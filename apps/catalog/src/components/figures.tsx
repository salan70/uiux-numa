// 方針ページで規則の意図を伝える図版。
// 正本は Markdown に置かず、画面の側で管理する。キーは docs/guidelines の `- 図:` が指す。
// 図版は --cat-* と typography だけで組み、選択中の配色とテーマに追従させる。
import React from "react";
import type { FigureKey } from "../content/guidelines";
  ...
  return (
    <div className="guide-figure__grid">
      <div className="guide-figure__card guide-figure__card--bad">
        ...
        >
          <div style={{ fontSize: "var(--font-size-sm)", color: "var(--cat-muted)" }}>氏名</div>
          <div
            style={{
          ...
          <div style={{ fontSize: "var(--font-size-sm)", color: "var(--cat-muted)" }}>
            メールアドレス
          </div>
          <div
            style={{
    ...
    <div className="guide-figure__grid">
      <div className="guide-figure__card guide-figure__card--bad">
        ...
        >
          ...
          <div
            style={{ fontSize: "var(--font-size-sm)", color: "var(--cat-muted)", marginLeft: "0" }}
          >
            通知の設定を変更します。
          </div>
          <div
      ...
      <div className="guide-figure__card guide-figure__card--good">
        ...
        <div
          ...
          style={{
            ...
            gap: "0.5rem",
            borderLeft: "1px dashed var(--cat-accent)",
            paddingLeft: "0.5rem",
          }}
        >
          <div
  ...
  return (
    <div className="guide-figure__grid">
      <div className="guide-figure__card guide-figure__card--bad">
        ...
        >
          <div style={{ fontSize: "var(--font-size-sm)", color: "var(--cat-text)" }}>
            見出しの文字階梯
          </div>
          <div style={{ fontSize: "var(--font-size-sm)", color: "var(--cat-text)" }}>
        ...
        >
          <div
            style={{
              ...
              borderBottom: "2px solid var(--cat-accent)",
              fontWeight: "var(--font-weight-bold)",
              fontSize: "var(--font-size-sm)",
            }}
          >
